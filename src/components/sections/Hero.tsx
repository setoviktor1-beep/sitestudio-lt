      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-8 border-t border-white/10 pt-8">
          <div className="text-center">
            ...
            <p className="text-xs text-white/50 uppercase tracking-widest">Projektų</p>
          </div>
          <div className="h-8 w-px bg-white/10" />
          <div className="text-center">
            <p className="text-2xl font-black text-white">3-5d</p>
            <p className="text-xs text-white/50 uppercase tracking-widest">Pristatymas</p>
          </div>
          <div className="h-8 w-px bg-white/10" />
          <div className="text-center">
            <p className="text-2xl font-black text-white">100%</p>
            <p className="text-xs text-white/50 uppercase tracking-widest">Kokybė</p>
          </div>
        </div>
      </div>
    </section>
